        ...
        <div className='mb-10 sm:flex justify-center'>
            ...
            <div className='flex-[1.3] flex justify-start flex-col mt-10'>
                ...
                <div className='flex text-xl gap-2'>
                    Colors
                    <div className='bg-black w-[2rem] h-[2rem] rounded-full'></div>
                    <div className='bg-gray-400 w-[2rem] h-[2rem] rounded-full'></div>
                    <div className='bg-white w-[2rem] h-[2rem] border-2 border-gray-300 rounded-full'></div>
                </div>
            </div>     
        </div>
        <Newsletter/>
